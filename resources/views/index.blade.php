...
<nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
    <div class="container">
        ...
        <!-- Image Logo -->
        <a class="navbar-brand logo-image" href="index.html"><img src="{{url('/assets/images/logofront.png')}}" width="auto" height="150px" alt="alternative"></a>
            ...
            <div class="row">
                <div class="col-lg-6 col-xl-5">
                    <div class="text-container">
                        <h1>Oque é 4Tag.me</h1>
                        <p class="p-large">Geramos cartões de visistas virtual dispensando cartões de visita de papel.Crie sua escolha um plano e personalize a pagina do seu cartão de visita.</p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <p class="p-heading">Automação de Marketing
                    Leve sua estratégia de negócios para o próximo nível e automatize suas tarefas de marketing para economizar tempo no desenvolvimento de produtos. Com Facebook Pixel facilite suas campanhas de marketing.

                    4Tag.me  fornece resultados com numero de visistas dirarias a sua pagina.</p>
            </div> <!-- end of col -->
        </div> <!-- end of row -->
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="tab-content" id="argoTabsContent">
                    ...
                    <div class="tab-pane fade show active" id="tab-1" role="tabpanel" aria-labelledby="tab-1">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="text-container">
                                    <h3>Rapido e Fácil</h3>
                                    <p>É muito fácil começar a usar o 4Tag.me. Basta cadastrar e terá acesso ao app e a todas as suas funcionalidades(Conforme o plano assinado). <a class="blue page-scroll" href="sign-up.html">Registre-se agora</a></p>
                                    <ul class="list-unstyled li-space-lg">
                                        <li class="media">
                                            <i class="fas fa-square"></i>
                                            <div class="media-body">Crie sua pagina customizada em instantes.</div>
                                        </li>
                                        <li class="media">
                                            <i class="fas fa-square"></i>
                                            <div class="media-body">Gerencie formulários e páginas de destino para seus serviços</div>
                                        </li>
                                        <li class="media">
                                            <i class="fas fa-square"></i>
                                            <div class="media-body">Analisar visitas diarias na sua pagina.</div>
                                        </li>
                                    </ul>
...
<div id="details" class="basic-1">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="text-container">
                    <h2>Agora é a hora de atualizar sua solução de marketing</h2>
                    <p>Direcione os clientes certos para o seu negócio com a ajuda da tecnologia  e implemente campanhas de marketing eficientes. Mantenha seus clientes satisfeitos e fiéis.</p>
                    <ul class="list-unstyled li-space-lg">
                        <li class="media">
                            <i class="fas fa-square"></i>
                            <div class="media-body">Promover a conexão rapida entre você e seu cliente, esse é o nosso objetivo</div>
                        </li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="p-heading">Passe seu contato atravez de um QR code (Disponivel em todos os planos) Numero de telefone, instagram, facebook, whatsapp</div>
            </div> <!-- end of col -->
        </div> <!-- end of row -->
    </div> <!-- end of container -->
</div> <!-- end of basic-2 -->
...
<div id="pricing" class="cards-2">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="above-heading">Planos & Preços</div>
                <h2 class="h2-heading">Opções de planos</h2>
            </div> <!-- end of col -->
        </div> <!-- end of row -->
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-title">Plano 01</div>
                        <div class="price"><span class="currency">R$</span><span class="value">5,90</span></div>
                        <div class="frequency">Mensal</div>
                        <div class="divider"></div>
                        <ul class="list-unstyled li-space-lg">
                            <li class="media">
                                <i class="fas fa-check"></i><div class="media-body">Faça cartões com todos os recursos</div>
                            </li>
                            <li class="media">
                                <i class="fas fa-check"></i><div class="media-body">Informações sem limites</div>
                            </li>
                            <li class="media">
                                <i class="fas fa-check"></i><div class="media-body">Insira conteúdos exclusivos</div>
                            </li>
                            <li class="media">
                                <i class="fas fa-check"></i><div class="media-body">Customize a aparência dos cartões</div>
                            </li>
                            <li class="media">
                                <i class="fas fa-check"></i><div class="media-body">Facebook Pixel - Integração</div>
                            </li>
                        </ul>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-title">Plano 02</div>
                        <div class="price"><span class="currency">R$</span><span class="value">14,90</span></div>
                        <div class="frequency">Trimensal</div>
                        <div class="divider"></div>
                        <ul class="list-unstyled li-space-lg">
                            <li class="media">
                                <i class="fas fa-check"></i><div class="media-body">Faça cartões com todos os recursos</div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-title">Plano 03</div>
                        <div class="price"><span class="currency">R$</span><span class="value">45,00</span></div>
                        <div class="frequency">Anual</div>
                        <div class="divider"></div>
                        <ul class="list-unstyled li-space-lg">
                            <li class="media">
                                <i class="fas fa-check"></i><div class="media-body">Faça cartões com todos os recursos</div>
